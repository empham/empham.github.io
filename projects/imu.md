...
<img src="../img/imu/setup.png" style="float:left" width="881px" alt="diagram illustrating the positioning of the IMU sensors and reflective markers on the right arm.">
...
<img src="../img/imu/LSTM-diagram.png" max-width="856px" alt="simplified diagram of LSTM model.">
<img src="../img/imu/estimate-angle.png" width="2055px" alt="sample results from LSTM.">
